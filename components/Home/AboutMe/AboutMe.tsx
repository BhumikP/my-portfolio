...
export default function AboutMe(props) {
  const technologies = [
    ["React js", "Next js", "JavaScript (ES6+)", "HTML", "Bootstrap"],
    ["Node.js", "Serverless", "TypeScript", "GraphQL", "Antd"],
  ];
  return (
    <div
      id="aboutSection"
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400  tracking-wide">
                Hello! My name is Bhumik and I enjoy solving problems and
            ...
            <div className="font-Header tracking-wide">
              <span className="text-gray-400  ">
                ...
                Serverless also. I'm also a long-time lover of YouTube who has
